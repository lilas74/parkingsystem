...
public class FareTest extends FareCalculatorServiceTest {
    ...
    /**
     * Verify fare are set corretly for A car test.
     *
     * @param arg the arg
     */
    ...
    /**
     * Verify fare are set corretly for A bike test.
     *
     * @param arg the arg
     */
    ...
    /**
     * Verify free fare are set corretly for A bike test.
     *
     * @param arg the arg
     */
    ...
    /**
     * Verify free fare are set corretly for A car test.
     *
     * @param arg the arg
     */
    @ParameterizedTest(name = "{index} => {0} x CAR_RATE_PER_HOUR doit être égal à {0} * 0")
    ...
    /**
     * Verify fare constant are public static final test.
     *

...
class ParkingSpotDAOIT {
     ...
     *
     * @return the next available car spot test
     */
     ...
     *
     * @return the next available car spot empty data test
     */
     ...
     *
     * @return the next available bike spot empty data test
     */
     ...
     *
     * @return the next available bike spot test
     */
     ...
     *
     * @return the next available bike spot error test
     */
     ...
     *
     * @return the next available car slot error test
     */

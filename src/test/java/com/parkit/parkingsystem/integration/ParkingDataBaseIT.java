...
public class ParkingDataBaseIT {
	...
	assertNotNull(ticket.getParkingSpot(), "Ticket doesn't save any parking spot");
	assertFalse(ticket.getParkingSpot().isAvailable(), "The parking table is not updated");
	assertNotNull(ticket, "Ticket is not save in the database");// generated ticket
	...
	assertNotNull(parkingSpot, "Parking Spot is not generated");
	assertEquals(parkingSpot.isAvailable(), false, "The parking spot hasn't been updated with availability");
    ...
    /**
     * Test recurent user exiting false.
     */
	...
	assertFalse(recurrentUserTest, "The first time user is set as a recurent user instead of false");
    }
}
